...
class CLIP_CORE(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        super(CLIP_CORE, self).__init__(config, dataset)
    ...
    def forward(self, item_seq):
        ...
        x = gate_weight_item * item_normalized + gate_weight_cprompt * cprompt_normalized
